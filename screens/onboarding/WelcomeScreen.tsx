...
import { useProfile } from "../../lib/teams-queries";
...
export function WelcomeScreen({ navigation }: Props) {
  ...
  return (
    <ScreenContainer centered>
      {profileData ? (
        <Text style={styles.title}>Welcome {profileData.first_name}</Text>
      ) : (
        <Text style={styles.title}>You&apos;re not on a team yet</Text>
      )}
      {/* <Text style={styles.title}>You&apos;re not on a team yet</Text> */}
      <Text style={styles.subtitle}>
        Coaches create a team and share a join code. Players join with the code
        their coach gave them.
      </Text>
